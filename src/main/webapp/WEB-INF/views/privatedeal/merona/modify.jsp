...
<body>
	...
	<div class="container-fluid">           
        <div class="container-fluid">           
            <div class="container">
                <h3>올때 메로나</h3>            
                <form action="/modify.do" method="post" id="insertBoardFrm" enctype="multipart/form-data">
                            ...
                            <tr>
                                ...
                                <td class="category">
                                    <select name="bigcategory">
                                        ...
                                        <option value="400" ${merona.smallcategory.midCategory.bigCategory.id eq '400' ? 'selected' : '' }>유럽</option>                                                                                
                                        <option value="500" ${merona.smallcategory.midCategory.bigCategory.id eq '500' ? 'selected' : '' }>아시아</option>                                                                                
                                        <option value="600" ${merona.smallcategory.midCategory.bigCategory.id eq '600' ? 'selected' : '' }>북아메리카</option>                                                                                
                                        <option value="700" ${merona.smallcategory.midCategory.bigCategory.id eq '700' ? 'selected' : '' }>남아메리카</option>                                                                                
                                        <option value="800" ${merona.smallcategory.midCategory.bigCategory.id eq '800' ? 'selected' : '' }>오세아니아</option>                                                                                                
                                        <option value="900" ${merona.smallcategory.midCategory.bigCategory.id eq '900' ? 'selected' : '' }>아프리카</option>                                                                                                
                                    </select>
                    ...
                    <div class="form-group text-center">
                        ...
                        <a href="/merona/detail.do?no=${param.no }" class="btn btn-default">취소</a>
                    </div>
