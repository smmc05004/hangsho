			               ...
			               <tr>
			                    ...
			                    <td>
			                        <div class="form-group">
			                            <input type="text" class="form-control" name="name" id="product-name-input"/>
			                        </div>
			                    </td>
			                </tr>
			                <tr>
			                ...
			                <tr>
			                    <th>배송비</th>
			                    <td>
			                        <input type="number" class="form-control" min="0" max="2500" maxlength="4"  name="deliveryFee" id="delivery-input"/>
			                    </td>
			                </tr>
			                <tr>
			                    <th>상품 설명</th>
			                ...
			                <tr>
			                    <th>할인률</th>
			                    <td>
			                        <input type="number" class="form-control" min="0" max="99" maxlength="2" name="discountRatio" id="discount-ratio"/>
			                    </td>
			                </tr>
			                <tr>
			                    <th>메인 이미지</th>
